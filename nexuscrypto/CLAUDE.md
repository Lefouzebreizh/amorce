# nexuscrypto — guide du sous-projet

Moteur d'investissement autonome, Python asynchrone. **Garde-fou permanent du 10/09/2026 : aucun paramètre critique — seuil de décision, capital engagé, plateforme d'exécution — ne se change en autonomie.** Le mode papier est le défaut.
...
2. **`Projet : nexuscrypto` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/nexuscrypto.md`, la boîte aux lettres de ce
