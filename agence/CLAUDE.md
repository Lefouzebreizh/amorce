...
# agence — guide du sous-projet

Socle de production livré aux clients — Next.js 16, Supabase (PostgreSQL + RLS), Server Actions. Se vérifie depuis ce dossier, jamais depuis la racine.
...
2. **`Projet : agence` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/agence.md`, la boîte aux lettres de ce
