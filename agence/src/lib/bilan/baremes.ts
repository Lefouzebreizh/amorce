...
// le conseiller local refuse de conseiller sur un cours périmé. Un taux
// présenté comme celui d'aujourd'hui alors qu'il ne l'est plus ferait calculer
// un manque à gagner faux, avec l'aplomb d'un chiffre juste.
//
// Copié depuis bilan-patrimoine/src/baremes.ts (lot 1) pour le lot 2. Cette
// copie est un instantané figé : quand les taux sont mis à jour dans
// bilan-patrimoine/, ce fichier doit l'être à la main, de la même manière —
// voir agence/src/lib/bilan/README.md.
...
/**
 * Relues le 3 septembre 2026 face aux quatre sources citées dans le README de
 * bilan-patrimoine (§2) : Banque de France, arrêté annuel, France Assureurs,
 * INSEE. Le prochain tour de mise à jour est décrit là-bas.
 */
