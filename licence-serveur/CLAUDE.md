# licence-serveur — guide du sous-projet

Le serveur de licence d'Amorce, et l'unique exception à sa promesse : trois routes, zéro dépendance, et **aucun média ne l'atteint jamais**. Se vérifie depuis ce dossier.
...
2. **`Projet : licence-serveur` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/licence-serveur.md`, la boîte aux lettres de ce
