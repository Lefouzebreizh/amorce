# tiktok — guide du sous-projet

Concepts et scripts, sans code. Les contraintes de cadrage et de son du §2 de la racine décident ici plus qu'ailleurs : une vidéo verticale n'est jamais vue en plein cadre.
...
2. **`Projet : tiktok` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/tiktok.md`, la boîte aux lettres de ce
