...
# titan-builder — guide du sous-projet

La plateforme où le client configure son site vitrine en cinq étapes. Le prix est **recalculé côté serveur**, jamais lu depuis le navigateur. `src/lib/charte.ts` décide de la teinte depuis le métier.
...
2. **`Projet : titan-builder` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/titan-builder.md`, la boîte aux lettres de ce
