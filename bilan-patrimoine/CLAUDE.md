# bilan-patrimoine — guide du sous-projet

Le diagnostic patrimonial grand public — TypeScript nu, zéro dépendance d'exécution. Les barèmes sont une table versionnée, et tant qu'un barème est périmé aucun montant en euros ne s'affiche.
...
2. **`Projet : bilan-patrimoine` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/bilan-patrimoine.md`, la boîte aux lettres de ce
