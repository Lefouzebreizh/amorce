# comptes-serveur — guide du sous-projet

Comptes et grand livre de crédits de la génération intégrée d'Amorce. Zéro dépendance d'exécution, `Base` comme seule interface avec D1. Se vérifie depuis ce dossier.
...
2. **`Projet : comptes-serveur` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/comptes-serveur.md`, la boîte aux lettres de ce
