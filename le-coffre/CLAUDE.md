...
# le-coffre — guide du sous-projet

Coffre-fort de documents chiffré côté navigateur, multi-utilisateurs. La phrase secrète n'atteint jamais le service : Supabase ne reçoit que des octets opaques.
...
2. **`Projet : le-coffre` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/le-coffre.md`, la boîte aux lettres de ce
