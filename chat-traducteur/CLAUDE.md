# chat-traducteur — guide du sous-projet

Traducteur de miaulements — Python et YAMNet en TFLite, plus un portage TypeScript dans `web/` tenu par des témoins engendrés depuis le Python. Le §2 de la racine s'applique en plein : un signal de santé animale ne compte que validé sur des données réelles.
...
2. **`Projet : chat-traducteur` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/chat-traducteur.md`, la boîte aux lettres de ce
