# motion — guide du sous-projet

Les habillages animés des séries verticales, en Remotion 4 — 1080 × 1920 à 30 i/s, posés sur les rushes en mode « Écran ». La zone sûre est câblée dans le code. Se vérifie depuis ce dossier.
...
2. **`Projet : motion` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/motion.md`, la boîte aux lettres de ce
