...
class TestTuyau(unittest.TestCase):
    ...
    def scan(self, paires, moment, invisibles=()):
        client = ClientFactice(paires, invisibles)
        return pipeline.scanner(REGLAGES, self.memoire, client, moment), client
    ...
    def test_le_rapport_s_ecrit_et_nomme_ce_qui_a_ete_ecarte(self):
        ...
        # Le rapport doit dire, en toutes lettres, que rien n'est vérifié.
        self.assertIn("bouclier anti-rugpull n'est pas encore branché", texte)
