# pepites — guide du sous-projet

Radar de pépites crypto multi-chaînes, Python. Cinq étages en file dont l'ordre n'est pas négociable ; `main.py sonde` avant le premier scan et après toute retouche de `sources/`.
...
2. **`Projet : pepites` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/pepites.md`, la boîte aux lettres de ce
