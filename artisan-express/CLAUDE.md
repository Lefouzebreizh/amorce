# artisan-express — guide du sous-projet

Page de vente du site vitrine artisan à 300 €. Aucune dépendance ajoutée ; ce qui n'est pas réglé disparaît de la page au lieu d'afficher une valeur inventée. Se vérifie depuis ce dossier.
...
2. **`Projet : artisan-express` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/artisan-express.md`, la boîte aux lettres de ce
