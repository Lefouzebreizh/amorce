# montage-auto — guide du sous-projet

Chaîne de montage automatisée, Python. Ses rushes et ses exports n'ont pas leur place dans Git — le dépôt n'accepte aucun binaire versionné.
...
2. **`Projet : montage-auto` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/montage-auto.md`, la boîte aux lettres de ce
