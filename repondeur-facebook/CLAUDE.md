# repondeur-facebook — guide du sous-projet

Réponses aux commentaires via l'API Graph, Python. Ce qui part en public au nom d'Erwann est l'une des trois exceptions du §0 : une réponse publiée ne se retire pas.
...
2. **`Projet : repondeur-facebook` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/repondeur-facebook.md`, la boîte aux lettres de ce
