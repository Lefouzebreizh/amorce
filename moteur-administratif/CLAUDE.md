# moteur-administratif — guide du sous-projet

Le moteur partagé de cinq produits personnels — Python, quatre briques indépendantes. **Il ne porte aucune règle métier** : chaque brique reçoit sa configuration du produit appelant. Aucune brique ne sort sur le réseau.
...
2. **`Projet : moteur-administratif` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/moteur-administratif.md`, la boîte aux lettres de ce
