# annuaire-ia — guide du sous-projet

Onze sites de niche à gabarit partagé, mis en ligne par GitHub Pages. Le lien d'affiliation est la seule chose qui rapporte : le compter présent et cliquable, jamais l'absence de lien mort.
...
2. **`Projet : annuaire-ia` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/annuaire-ia.md`, la boîte aux lettres de ce
