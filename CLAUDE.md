Warning: truncated output (original token count: 58607)
...
- **audit-radar/** — radar Python de prospects pour audits d'applications IA.
  Il ne lit qu'une page publique, garde un score déterministe et n'envoie rien.
  La lecture DeepSeek optionnelle passe par Vercel AI Gateway après retrait des
  coordonnées et secrets ; elle est interdite aux données Coffre, MDPH, santé,
  identité et banque, et ne remplace jamais la validation humaine.
...
Être bloqué en pleine tâche parce qu'on a trop dépensé e…8607 tokens truncated…'exécute pas, elle ordonne — juger la matière, le son avant l'image, monter,
