...
import { DEFAULT_CLIP, type Caption, type Clip, type MediaAsset, type Project } from '../types.ts';
...
function project(overrides: Partial<Project> = {}): Project {
  return { name: 't', assets: [asset()], clips: [], captions: [], cues: [], music: null, ...overrides };
}
