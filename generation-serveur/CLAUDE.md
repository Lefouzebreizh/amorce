# generation-serveur — guide du sous-projet

La passerelle de génération d'Amorce — MiniMax, plafond de 20 $/mois en veto avant tout appel. Aucun média de l'appareil n'y monte. Se vérifie depuis ce dossier.
...
2. **`Projet : generation-serveur` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/generation-serveur.md`, la boîte aux lettres de ce
