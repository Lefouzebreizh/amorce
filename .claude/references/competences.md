...
| `/creation-application` | Poser l'architecture d'une application qui porte de la logique et des données — pas un site vitrine : où passe la frontière entre décider, toucher au… |
...
| `/reseau-annuaires` | Travailler sur le réseau d'annuaires d'outils IA (`annuaire-ia/`) — onze sites de niche qui partagent un gabarit, une feuille de style compilée et un… |
