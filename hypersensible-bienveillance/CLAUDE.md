# hypersensible-bienveillance — guide du sous-projet

Astro, Cloudflare Pages, D1, R2, un Worker cron. Ses décisions et ses pièges vivent dans son `public/llms.txt`. Se vérifie depuis ce dossier.
...
2. **`Projet : hypersensible-bienveillance` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/hypersensible-bienveillance.md`, la boîte aux lettres de ce
