# paper-manager — guide du sous-projet

Assistant administratif : scan, échéances, résiliations. Python. Source de la lettre de résiliation et de la détection d'échéance.
...
2. **`Projet : paper-manager` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/paper-manager.md`, la boîte aux lettres de ce
