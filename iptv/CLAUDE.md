...
# iptv — guide du sous-projet

Tableau de bord de gestion et de lecture IPTV / VOD — TypeScript, zéro dépendance d'exécution dans le cœur. Une liste M3U ne se charge jamais en mémoire. Se vérifie depuis ce dossier.
...
2. **`Projet : iptv` en tête de la toute première réponse** — racine, §9 — et
...
Et avant le premier geste : `inbox/iptv.md`, la boîte aux lettres de ce
